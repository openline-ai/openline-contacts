        ...
        <FullScreenModeLayout fullScreenMode >
            ...
            <article className="flex flex-column mb-3">
                ...
                <div style={{ maxWidth: '25rem', width: '100%'}}>
                    ...
                    <input id="openline-hubspot-api-key"  className="flex w-full mb-3 pt-2 pb-1 pr-2 pl-2"  onChange={({target: {value}}) => setHubspotPrivateAppKey(value)}/>
            ...
            <article className="flex flex-column" >
                ...
                <div style={{ maxWidth: '25rem', width: '100%'}}>
                    ...
                    <input id="openline-zendesk-api-key"  className="flex w-full mb-4 pt-2 pb-1 pr-2 pl-2" onChange={({target: {value}}) => setZendeskApiKey(value)}/>
                    <label htmlFor="openline-zendesk-subdomain" className="mb-2 block text-gray-800">Subdomain</label>
                    <input id="openline-zendesk-subdomain"  className="flex w-full mb-4 pt-2 pb-1 pr-2 pl-2" onChange={({target: {value}}) => setZendeskSubdomain(value)}/>
                    <label htmlFor="openline-zendesk-admin-email" className="mb-2 block text-gray-800">Admin Email</label>
                    <input id="openline-zendesk-admin-email"  className="flex w-full pt-2 pb-1 pr-2 pl-2 mb-3" onChange={({target: {value}}) => setAdminEmail(value)}/>
                   <div className="flex justify-content-end">
